    ...
    <div className="min-h-screen bg-white text-black">
      <main className="p-6">
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          <Card className="bg-white border-purple-400 border-r-4 border-b-4 w-full lg:w-[500px] hover:shadow-purple-400 hover:shadow-lg transition-shadow">
              ...
              return (
                ...
                >
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-green-400">+X from last month</p>
                  </CardContent>
                </Card>
              )
            })}
